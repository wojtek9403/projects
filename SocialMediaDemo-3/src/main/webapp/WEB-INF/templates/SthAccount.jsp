...
<body>
	...
	<div id="container" align="center">
		...
		<div id="header2">
			...
			<div class="details">
				<label class="nameLabel">${userDetails.name}</label>
				<label class="nameLabel">${userDetails.surname}</label>
			</div>

			<div class = "Follow">
				<form method="post" action="/SocialMediaDemo/addUserToFollow">
					
					<input name = "toFollow" type = "hidden" value="${userDetails.username}"/>
